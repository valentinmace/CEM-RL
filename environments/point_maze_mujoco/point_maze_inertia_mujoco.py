...
from environments.point_maze_mujoco.maze_utils import MAZE, THREE_CORRIDORS_MAZE, START
from environments.point_maze_mujoco.maze_utils import parse_maze, point_maze

import numpy as np


class PointMazeInertiaMujoco(mujoco_env.MujocoEnv, utils.EzPickle):
    """Mujoco simulation of a deceptive maze."""
    def __init__(self,
                 maze_spec: MAZE = THREE_CORRIDORS_MAZE,
                 reward_type: str = 'dense',
                 reset_target: bool = False,
                 max_timesteps: int = 350):
